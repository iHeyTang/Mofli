...
import { clamp, createRng, loopNoise } from './face-math.js'
...
/** Shared surface/eye orientation; preserves the calibrated Bloub basis. */
export function headBasis(gaze: HeadGaze) {
  let f: Vec3 = [0, 0, 1]
